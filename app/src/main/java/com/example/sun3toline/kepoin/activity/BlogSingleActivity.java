...
public class BlogSingleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBlogSingleDesc = findViewById(R.id.single_desc);
        mBlogSingleImage = findViewById(R.id.single_image);
        mBlogSingleTitle = findViewById(R.id.single_title);
        mBlogSingleKategori = findViewById(R.id.single_kategori);
        mBlogSingleProvinsi = findViewById(R.id.single_provinsi);
        mSingleRemoveBtn = findViewById(R.id.singleRemovebtn);
        mBlogSingleUsername = findViewById(R.id.single_username);
